...
<div style="text-align: left;">
  <a href="http://www.pratt.edu/academics/information_and_library_sciences/">
    <img style="padding: 15px;" src="{{ "assets/logo_pratt.jpg" | relative_url }}" alt="Pratt Institute" width="10%" />
  </a>
  <a href="http://www.oclc.org/us/en/default.htm">
    <img style="padding: 15px;" src="{{ "assets/logo_oclc.png" | relative_url }}" alt="OCLC" width="13%" />
  </a>
  <a href="http://www.alise.org/">
    <img style="padding: 15px;" src="{{ "assets/logo_alise.jpg" | relative_url }}" alt="Alise" width="10%" />
  </a> 
  <a href="http://www.jazzandheritage.org/">
    <img style="padding: 15px;" src="{{ "assets/logo_new_orleans_jazz_&_heritage_festival_and_foundation.png" | relative_url }}" alt="New Orleans Jazz and Heritage Foundation" width="16%" />
  </a>
  <a href="http://www.ellafitzgeraldfoundation.org/">
    <img style="padding: 15px;" src="{{ "assets/logo_ella_fitzgerald_charitable_foundation.jpg" | relative_url }}" alt="Ella Fitzgerald Charitable Foundation" width="13%" />
  </a>
  <a href="https://www.jazzednet.org/">
    <img style="padding: 15px;" src="{{ "assets/logo_jazz_education_network.jpg" | relative_url }}" alt="Jazz Education Network" width="9%" />
  </a>
</div>
