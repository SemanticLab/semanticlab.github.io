...
<img style="padding: 8px; width: 270px;" src="{{ "assets/logo_drawings_of_the_florentine_painters.png" | relative_url }}" alt="Drawings of the Florentine Painters logo" width="100%"/><br/>**Florentine Renaissance Drawings: A Linked Catalogue for the Semantic Web**
