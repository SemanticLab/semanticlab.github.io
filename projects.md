...
The Mary Berenson Project intends to investigate the application of computational analysis techniques to archival documents to automate the generation of linked open data with the goal of creating networked narratives. upported by the Pratt School of Information Faculty Innovation Fund and in collaboration with [The Harvard University Center for Italian Renaissance Studies, Villa I Tatti](http://itatti.harvard.edu/), the project focuses on the collections of diaries and letters from the Berenson Archives held at the Villa I Tatti.<br/>
